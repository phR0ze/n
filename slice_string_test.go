...
func TestStringSlice_AnyW(t *testing.T) {
	...
	assert.False(t, NewStringSliceV().AnyW(func(x O) bool { return ExB(x.(int) > 0) }))

	// single
	assert.True(t, NewStringSliceV(2).AnyW(func(x O) bool { return ExB(x.(int) > 0) }))

	assert.True(t, NewStringSliceV("1", "2").AnyW(func(x O) bool { return ExB(x.(int) == 2) }))
	assert.True(t, NewStringSliceV("1", "2").AnyW(func(x O) bool { return ExB(x.(int)%2 == 0) }))
	assert.False(t, NewStringSliceV(2, 4).AnyW(func(x O) bool { return ExB(x.(int)%2 != 0) }))
	assert.True(t, NewStringSliceV("1", "2", "3").AnyW(func(x O) bool { return ExB(x.(int) == 4 || x.(int) == 3) }))
}
...
// 	assert.Equal(t, 0, NewStringSliceV().CountW(func(x O) bool { return ExB(x.(int) > 0) }))

// 	assert.Equal(t, 1, NewStringSliceV("2", "3").CountW(func(x O) bool { return ExB(x.(int) > 2) }))
// 	assert.Equal(t, 1, NewStringSliceV("1", "2").CountW(func(x O) bool { return ExB(x.(int) == 2) }))
// 	assert.Equal(t, 2, NewStringSliceV(1, 2, 3, 4, 5).CountW(func(x O) bool { return ExB(x.(int)%2 == 0) }))
// 	assert.Equal(t, 3, NewStringSliceV(1, 2, 3, 4, 5).CountW(func(x O) bool { return ExB(x.(int)%2 != 0) }))
// 	assert.Equal(t, 1, NewStringSliceV("1", "2", "3").CountW(func(x O) bool { return ExB(x.(int) == 4 || x.(int) == 3) }))
// }
...
// 	// invalid
// 	assert.Equal(t, &Object{nil}, NewStringSliceV().First())

// 	// int
// 	assert.Equal(t, &Object{2}, NewStringSliceV("2", "3").First())
// 	assert.Equal(t, &Object{3}, NewStringSliceV(3, 2).First())
// 	assert.Equal(t, &Object{"1"}, NewStringSliceV(1, 3, 2).First())
// }
...
// 	src := []string{}
// 	for i := 0; i < len(src); i++ {
// 		src = append(src, fmt.Sprintf("%v", src[i]))
// 	}
// 	strings.Join(src, ",")
// }
...
// 	// empty
// 	{
// 		assert.Equal(t, &Object{""}, NewStringSliceV().Join())
// 	}
...
// 	// invalid
// 	assert.Equal(t, &Object{nil}, NewStringSliceV().Last())

// 	// int
// 	assert.Equal(t, &Object{3}, NewStringSliceV("2", "3").Last())
// 	assert.Equal(t, &Object{2}, NewStringSliceV(3, 2).Last())
// 	assert.Equal(t, &Object{2}, NewStringSliceV(1, 3, 2).Last())
// }
...
// 		slice := NewStringSliceV(5, 3, -2, 4, -1)
// 		sorted := slice.Sort()
// 		assert.Equal(t, NewStringSliceV(-2, -1, 3, 4, 5, 6), sorted.Append(6))
// 		assert.Equal(t, NewStringSliceV(5, 3, -2, 4, -1), slice)
// 	}
// }
...
// 		sorted := slice.SortM()
// 		assert.Equal(t, NewStringSliceV(-2, -1, 3, 4, 5, 6), sorted.Append(6))
// 		assert.Equal(t, NewStringSliceV(-2, -1, 3, 4, 5, 6), slice)
// 	}
// }
...
// 		slice := NewStringSliceV(5, 3, -2, 4, -1)
// 		sorted := slice.SortReverse()
// 		assert.Equal(t, NewStringSliceV(5, 4, 3, -1, -2, 6), sorted.Append(6))
// 		assert.Equal(t, NewStringSliceV(5, 3, -2, 4, -1), slice)
// 	}
// }
...
// 		sorted := slice.SortReverseM()
// 		assert.Equal(t, NewStringSliceV(5, 4, 3, -1, -2, 6), sorted.Append(6))
// 		assert.Equal(t, NewStringSliceV(5, 4, 3, -1, -2, 6), slice)
// 	}
// }
