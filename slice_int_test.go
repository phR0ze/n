...
func TestIntSlice_AnyS(t *testing.T) {
	...
	// Conversion
	{
		assert.True(t, NewIntSliceV(1, 2, 3).AnyS(NewIntSliceV(int64(1))))
		assert.True(t, NewIntSliceV(1, 2, 3).AnyS(NewIntSliceV("2")))
		assert.True(t, NewIntSliceV(1, 2, 3).AnyS(NewIntSliceV(true)))
		assert.True(t, NewIntSliceV(1, 2, 3).AnyS(NewIntSliceV(Str("3"))))
	}
}
...
func BenchmarkIntSlice_EachE_Slice(t *testing.B) {
	NewIntSlice(Range(0, nines6)).EachE(func(x O) error {
		assert.IsType(t, 0, x)
		return nil
	})
}
...
// EachI
//--------------------------------------------------------------------------------------------------
func BenchmarkIntSlice_EachI_Go(t *testing.B) {
	action := func(x interface{}) {
		assert.IsType(t, 0, x)
	}
	for i := range Range(0, nines6) {
...
func BenchmarkIntSlice_EachI_Slice(t *testing.B) {
	NewIntSlice(Range(0, nines6)).EachI(func(i int, x O) {
		assert.IsType(t, 0, x)
	})
}

func ExampleIntSlice_EachI() {
...
func TestIntSlice_EachI(t *testing.T) {
...
// EachIE
//--------------------------------------------------------------------------------------------------
func BenchmarkIntSlice_EachIE_Go(t *testing.B) {
	action := func(x interface{}) {
		assert.IsType(t, 0, x)
	}
	for i := range Range(0, nines6) {
...
func BenchmarkIntSlice_EachIE_Slice(t *testing.B) {
...
func TestIntSlice_EachIE(t *testing.T) {
...
func BenchmarkIntSlice_EachR_Slice(t *testing.B) {
	NewIntSlice(Range(0, nines6)).EachR(func(x O) {
		assert.IsType(t, 0, x)
	})
}

func ExampleIntSlice_EachR() {
...
func TestIntSlice_EachR(t *testing.T) {
...
// EachRE
//--------------------------------------------------------------------------------------------------
func BenchmarkIntSlice_EachRE_Go(t *testing.B) {
	action := func(x interface{}) {
		assert.IsType(t, 0, x)
	}
	for i := range Range(0, nines6) {
...
func BenchmarkIntSlice_EachRE_Slice(t *testing.B) {
...
func TestIntSlice_EachRE(t *testing.T) {
...
func TestIntSlice_FirstN(t *testing.T) {
	...
	// Get none
	assert.Equal(t, NewIntSliceV(), NewIntSliceV(1, 2, 3).FirstN(0))
...
func TestIntSlice_Insert(t *testing.T) {
	...
	{
		slice := NewIntSliceV()
		assert.Equal(t, NewIntSliceV(0), slice.Insert(-1, []int{0}))
		assert.Equal(t, NewIntSliceV(0, 1), slice.Insert(-1, []int{1}))
		assert.Equal(t, NewIntSliceV(0, 1, 2), slice.Insert(-1, []int{2}))
	}
	...
	{
		slice := NewIntSliceV()
		assert.Equal(t, NewIntSliceV(2), slice.Insert(0, []int{2}))
		assert.Equal(t, NewIntSliceV(1, 2), slice.Insert(0, []int{1}))
		assert.Equal(t, NewIntSliceV(0, 1, 2), slice.Insert(0, []int{0}))
	}
	...
	{
		slice := NewIntSliceV(0, 5)
		assert.Equal(t, NewIntSliceV(0, 1, 2, 5), slice.Insert(1, []int{1, 2}))
		assert.Equal(t, NewIntSliceV(0, 1, 2, 3, 4, 5), slice.Insert(3, []int{3, 4}))
	}
	...
	{
		slice := NewIntSliceV(0, 5)
		assert.Equal(t, NewIntSliceV(0, 1, 2, 5), slice.Insert(-2, []int{1, 2}))
		assert.Equal(t, NewIntSliceV(0, 1, 2, 3, 4, 5), slice.Insert(-2, []int{3, 4}))
	}
	...
	// [] Conversion
	{
		assert.Equal(t, NewIntSliceV(1, 2, 3, 4), NewIntSliceV(1, 4).Insert(1, []Object{{2}, {3}}))
		assert.Equal(t, NewIntSliceV(1, 2, 3, 4), NewIntSliceV(1, 4).Insert(1, []string{"2", "3"}))
		assert.Equal(t, NewIntSliceV(0, 1, 2, 3), NewIntSliceV(2, 3).Insert(0, []bool{false, true}))
		assert.Equal(t, NewIntSliceV(1, 2, 3, 4), NewIntSliceV(1, 2).Insert(-1, []Char{'3', '4'}))
	}
}
...
func TestIntSlice_LastN(t *testing.T) {
	...
	// Get none
	{
		assert.Equal(t, NewIntSliceV(), NewIntSliceV(1, 2, 3).LastN(0))
	}
...
// Shift
//--------------------------------------------------------------------------------------------------
func BenchmarkIntSlice_Shift_Go(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 1 {
		ints = ints[1:]
	}
...
func BenchmarkIntSlice_Shift_Slice(t *testing.B) {
	slice := NewIntSlice(Range(0, nines7))
	for slice.Len() > 0 {
		slice.Shift()
	}
...
// ShiftN
//--------------------------------------------------------------------------------------------------
func BenchmarkIntSlice_ShiftN_Go(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 10 {
		ints = ints[10:]
	}
...
func BenchmarkIntSlice_ShiftN_Slice(t *testing.B) {
	slice := NewIntSlice(Range(0, nines7))
	for slice.Len() > 0 {
		slice.ShiftN(10)
	}
...
func ExampleIntSlice_ShiftN() {
	slice := NewIntSliceV(1, 2, 3)
	fmt.Println(slice.ShiftN(2))
	// Output: [1 2]
}

func TestIntSlice_ShiftN(t *testing.T) {
