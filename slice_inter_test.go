...
func TestInterSlice_ConcatM(t *testing.T) {
	...
	// Test all supported types
	{
		...
		{
			n := NewInterSliceV(0)
			assert.Equal(t, []int{0, 1}, n.ConcatM(NewInterSliceV(1)).O())
			assert.Equal(t, 2, n.Len())
		}
		...
		{
			n := NewInterSliceV(0)
			assert.Equal(t, []int{0, 1}, n.ConcatM(NewInterSlice([]int{1})).O())
			assert.Equal(t, 2, n.Len())
		}
...
// func TestInterSlice_ConcatM_wrongType(t *testing.T) {
// 	slice := NewInterSliceV(1)
// 	defer func() {
// 		err := recover()
// 		assert.Equal(t, "can't concat type '[]string' with '[]int'", err)
...
// // Copy
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Copy_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	dst := make([]int, len(ints), len(ints))
// 	copy(dst, ints)
// }

// func BenchmarkInterSlice_Copy_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines6))
// 	slice.Copy()
// }

// func BenchmarkInterSlice_Copy_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines6))
// 	slice.Copy()
// }
...
// 	// copy full array
// 	{
// 		assert.Equal(t, nil, NewInterSliceV().Copy().O())
// 		assert.Equal(t, nil, NewInterSliceV().Copy(0, -1).O())
// 		assert.Equal(t, nil, NewInterSliceV().Copy(0, 1).O())
// 		assert.Equal(t, nil, NewInterSliceV().Copy(0, 5).O())
// 		assert.Equal(t, []string{""}, NewInterSliceV("").Copy().O())
// 		assert.Equal(t, []string{""}, NewInterSliceV("").Copy(0, -1).O())
// 		assert.Equal(t, []string{""}, NewInterSliceV("").Copy(0, 1).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3).Copy().O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3).Copy(0, -1).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSlice([]int{1, 2, 3}).Copy().O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSlice([]int{1, 2, 3}).Copy(0, -1).O())
// 		assert.Equal(t, []string{"1", "2", "3"}, NewInterSliceV("1", "2", "3").Copy().O())
// 		assert.Equal(t, []string{"1", "2", "3"}, NewInterSliceV("1", "2", "3").Copy(0, 2).O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy().O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(0, -1).O())
// 	}

// 	// out of bounds should be moved in
// 	{
// 		assert.Equal(t, []string{"1"}, NewInterSliceV("1").Copy(0, 2).O())
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false).Copy(-6, 6).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3).Copy(-6, 6).O())
// 		assert.Equal(t, []string{"1", "2", "3"}, NewInterSliceV("1", "2", "3").Copy(-6, 6).O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(-6, 6).O())
// 	}
...
// 	// grab all but first
// 	{
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).Copy(1, -1).O())
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).Copy(1, 2).O())
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).Copy(-2, -1).O())
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).Copy(-2, 2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3).Copy(1, -1).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3).Copy(1, 2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3).Copy(-2, -1).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3).Copy(-2, 2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Copy(1, -1).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Copy(1, 2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Copy(-2, -1).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Copy(-2, 2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(1, -1).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(1, 2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(-2, -1).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(-2, 2).O())
// 	}

// 	// grab all but last
// 	{
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false, true).Copy(0, -2).O())
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false, true).Copy(-3, -2).O())
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false, true).Copy(-3, 1).O())
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false, true).Copy(0, 1).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3).Copy(0, -2).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3).Copy(-3, -2).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3).Copy(-3, 1).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3).Copy(0, 1).O())
// 		assert.Equal(t, []string{"1", "2"}, NewInterSliceV("1", "2", "3").Copy(0, -2).O())
// 		assert.Equal(t, []string{"1", "2"}, NewInterSliceV("1", "2", "3").Copy(-3, -2).O())
// 		assert.Equal(t, []string{"1", "2"}, NewInterSliceV("1", "2", "3").Copy(-3, 1).O())
// 		assert.Equal(t, []string{"1", "2"}, NewInterSliceV("1", "2", "3").Copy(0, 1).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(0, -2).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(-3, -2).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(-3, 1).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}}).Copy(0, 1).O())
// 	}

// 	// grab middle
// 	{
// 		assert.Equal(t, []bool{true, true}, NewInterSliceV(false, true, true, false).Copy(1, -2).O())
// 		assert.Equal(t, []bool{true, true}, NewInterSliceV(false, true, true, false).Copy(-3, -2).O())
// 		assert.Equal(t, []bool{true, true}, NewInterSliceV(false, true, true, false).Copy(-3, 2).O())
// 		assert.Equal(t, []bool{true, true}, NewInterSliceV(false, true, true, false).Copy(1, 2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3, 4).Copy(1, -2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3, 4).Copy(-3, -2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3, 4).Copy(-3, 2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3, 4).Copy(1, 2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3", "4").Copy(1, -2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3", "4").Copy(-3, -2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3", "4").Copy(-3, 2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3", "4").Copy(1, 2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Copy(1, -2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Copy(-3, -2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Copy(-3, 2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Copy(1, 2).O())
// 	}
...
// 	// random
// 	{
// 		assert.Equal(t, []string{"1"}, NewInterSliceV("1", "2", "3").Copy(0, -3).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Copy(1, 2).O())
// 		assert.Equal(t, []string{"1", "2", "3"}, NewInterSliceV("1", "2", "3").Copy(0, 2).O())
// 	}
// }
...
// // Count
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Count_Go(t *testing.B) {
// 	ints := Range(0, nines5)
// 	for i := range ints {
// 		if i == nines4 {
// 			break
...
// func BenchmarkInterSlice_Count_Optimized(t *testing.B) {
// 	src := Range(0, nines5)
// 	NewIntSlice(src).Count(nines4)
// }

// func BenchmarkInterSlice_Count_Reflect(t *testing.B) {
// 	src := Range(0, nines5)
// 	NewInterSlice(src).Count(nines4)
// }
...
// // CountW
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_CountW_Go(t *testing.B) {
// 	ints := Range(0, nines5)
// 	for i := range ints {
// 		if i == nines4 {
// 			break
...
// func BenchmarkInterSlice_CountW_Slice(t *testing.B) {
// 	src := Range(0, nines5)
// 	NewInterSlice(src).CountW(func(x O) bool {
...
// // Drop
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Drop_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 11 {
// 		i := 1
// 		n := 10
...
// func BenchmarkInterSlice_Drop_Optimized(t *testing.B) {
...
// func BenchmarkInterSlice_Drop_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines5))
// 	for slice.Len() > 1 {
// 		slice.Drop(1, 10)
// 	}
// }
...
// 	{
// 		// invalid
// 		assert.Equal(t, []int{1, 2, 3, 4}, NewInterSliceV(1, 2, 3, 4).Drop(1).O())
// 		assert.Equal(t, []int{1, 2, 3, 4}, NewInterSliceV(1, 2, 3, 4).Drop(4, 4).O())

// 		// drop 1
// 		assert.Equal(t, []int{2, 3, 4}, NewInterSliceV(1, 2, 3, 4).Drop(0, 0).O())
// 		assert.Equal(t, []int{1, 3, 4}, NewInterSliceV(1, 2, 3, 4).Drop(1, 1).O())
// 		assert.Equal(t, []int{1, 2, 4}, NewInterSliceV(1, 2, 3, 4).Drop(2, 2).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3, 4).Drop(3, 3).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3, 4).Drop(-1, -1).O())
// 		assert.Equal(t, []int{1, 2, 4}, NewInterSliceV(1, 2, 3, 4).Drop(-2, -2).O())
// 		assert.Equal(t, []int{1, 3, 4}, NewInterSliceV(1, 2, 3, 4).Drop(-3, -3).O())
// 		assert.Equal(t, []int{2, 3, 4}, NewInterSliceV(1, 2, 3, 4).Drop(-4, -4).O())

// 		// drop 2
// 		assert.Equal(t, []int{3, 4}, NewInterSliceV(1, 2, 3, 4).Drop(0, 1).O())
// 		assert.Equal(t, []int{1, 4}, NewInterSliceV(1, 2, 3, 4).Drop(1, 2).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3, 4).Drop(2, 3).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3, 4).Drop(-2, -1).O())
// 		assert.Equal(t, []int{1, 4}, NewInterSliceV(1, 2, 3, 4).Drop(-3, -2).O())
// 		assert.Equal(t, []int{3, 4}, NewInterSliceV(1, 2, 3, 4).Drop(-4, -3).O())

// 		// drop 3
// 		assert.Equal(t, []int{4}, NewInterSliceV(1, 2, 3, 4).Drop(0, 2).O())
// 		assert.Equal(t, []int{1}, NewInterSliceV(1, 2, 3, 4).Drop(-3, -1).O())

// 		// drop everything and beyond
// 		assert.Equal(t, []int{}, NewInterSliceV(1, 2, 3, 4).Drop().O())
// 		assert.Equal(t, []int{}, NewInterSliceV(1, 2, 3, 4).Drop(0, 3).O())
// 		assert.Equal(t, []int{}, NewInterSliceV(1, 2, 3, 4).Drop(0, -1).O())
// 		assert.Equal(t, []int{}, NewInterSliceV(1, 2, 3, 4).Drop(-4, -1).O())
// 		assert.Equal(t, []int{}, NewInterSliceV(1, 2, 3, 4).Drop(-6, -1).O())
// 		assert.Equal(t, []int{}, NewInterSliceV(1, 2, 3, 4).Drop(0, 10).O())

// 		// move index within bounds
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3, 4).Drop(3, 4).O())
// 		assert.Equal(t, []int{2, 3, 4}, NewInterSliceV(1, 2, 3, 4).Drop(-5, 0).O())
// 	}

// 	// int
// 	{
// 		// invalid
// 		assert.Equal(t, []Object{{1}, {2}, {3}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(1).O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(4, 4).O())

// 		// drop {1}
// 		assert.Equal(t, []Object{{2}, {3}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(0, 0).O())
// 		assert.Equal(t, []Object{{1}, {3}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(1, 1).O())
// 		assert.Equal(t, []Object{{1}, {2}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(2, 2).O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(3, 3).O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-1, -1).O())
// 		assert.Equal(t, []Object{{1}, {2}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-2, -2).O())
// 		assert.Equal(t, []Object{{1}, {3}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-3, -3).O())
// 		assert.Equal(t, []Object{{2}, {3}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-4, -4).O())

// 		// drop {2}
// 		assert.Equal(t, []Object{{3}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(0, 1).O())
// 		assert.Equal(t, []Object{{1}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(1, 2).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(2, 3).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-2, -1).O())
// 		assert.Equal(t, []Object{{1}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-3, -2).O())
// 		assert.Equal(t, []Object{{3}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-4, -3).O())

// 		// drop {3}
// 		assert.Equal(t, []Object{{4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(0, 2).O())
// 		assert.Equal(t, []Object{{1}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-3, -1).O())

// 		// drop everything and beyond
// 		assert.Equal(t, []Object{}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop().O())
// 		assert.Equal(t, []Object{}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(0, 3).O())
// 		assert.Equal(t, []Object{}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(0, -1).O())
// 		assert.Equal(t, []Object{}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-4, -1).O())
// 		assert.Equal(t, []Object{}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-6, -1).O())
// 		assert.Equal(t, []Object{}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(0, 10).O())

// 		// move index within bounds
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(3, 4).O())
// 		assert.Equal(t, []Object{{2}, {3}, {4}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Drop(-5, 0).O())
// 	}
// }

// // DropAt
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_DropAt_Go(t *testing.B) {
// 	ints := Range(0, nines5)
...
// func BenchmarkInterSlice_DropAt_Optimized(t *testing.B) {
// 	src := Range(0, nines5)
// 	index := Range(0, nines5)
...
// func BenchmarkInterSlice_DropAt_Reflect(t *testing.B) {
// 	src := Range(0, nines5)
// 	index := Range(0, nines5)
// 	slice := NewInterSlice(src)
// 	for i := range index {
// 		slice.DropAt(i)
// 	}
// }
...
// 	// drop invalid
// 	assert.Equal(t, []int{0, 1, 2}, NewInterSliceV(0, 1, 2).DropAt(3).O())
// 	assert.Equal(t, []int{0, 1, 2}, NewInterSliceV(0, 1, 2).DropAt(-4).O())

// 	// drop last
// 	assert.Equal(t, []int{0, 1}, NewInterSliceV(0, 1, 2).DropAt(2).O())
// 	assert.Equal(t, []int{0, 1}, NewInterSliceV(0, 1, 2).DropAt(-1).O())

// 	// drop middle
// 	assert.Equal(t, []int{0, 2}, NewInterSliceV(0, 1, 2).DropAt(1).O())
// 	assert.Equal(t, []int{0, 2}, NewInterSliceV(0, 1, 2).DropAt(-2).O())

// 	// drop first
// 	assert.Equal(t, []int{1, 2}, NewInterSliceV(0, 1, 2).DropAt(0).O())
// 	assert.Equal(t, []int{1, 2}, NewInterSliceV(0, 1, 2).DropAt(-3).O())
// }

// // DropFirst
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_DropFirst_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 1 {
// 		ints = ints[1:]
// 	}
...
// func BenchmarkInterSlice_DropFirst_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.DropFirst()
// 	}
...
// func BenchmarkInterSlice_DropFirst_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.DropFirst()
// 	}
// }
...
// // DropFirstN
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_DropFirstN_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 10 {
// 		ints = ints[10:]
// 	}
...
// func BenchmarkInterSlice_DropFirstN_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.DropFirstN(10)
// 	}
...
// func BenchmarkInterSlice_DropFirstN_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.DropFirstN(10)
// 	}
...
// // DropLast
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_DropLast_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 1 {
// 		ints = ints[1:]
// 	}
...
// func BenchmarkInterSlice_DropLast_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.DropLast()
// 	}
...
// func BenchmarkInterSlice_DropLast_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.DropLast()
// 	}
...
// // DropLastN
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_DropLastN_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 10 {
// 		ints = ints[10:]
// 	}
...
// func BenchmarkInterSlice_DropLastN_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.DropLastN(10)
// 	}
...
// func BenchmarkInterSlice_DropLastN_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.DropLastN(10)
// 	}
...
// // Each
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Each_Go(t *testing.B) {
...
// func BenchmarkInterSlice_Each_Optimized(t *testing.B) {
// 	NewIntSlice(Range(0, nines6)).Each(func(x O) {
// 		assert.IsType(t, 0, x)
// 	})
// }

// func BenchmarkInterSlice_Each_Reflect(t *testing.B) {
// 	NewInterSlice(rangeInterObject(0, nines6)).Each(func(x O) {
...
// // EachE
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_EachE_Go(t *testing.B) {
// 	action := func(x interface{}) {
// 		assert.IsType(t, 0, x)
// 	}
// 	for i := range Range(0, nines6) {
...
// func BenchmarkInterSlice_EachE_Optimized(t *testing.B) {
// 	NewIntSlice(Range(0, nines6)).Each(func(x O) {
// 		assert.IsType(t, 0, x)
// 	})
// }

// func BenchmarkInterSlice_EachE_Reflect(t *testing.B) {
// 	NewInterSlice(rangeInterObject(0, nines6)).Each(func(x O) {
// 		assert.IsType(t, Object{}, x)
// 	})
// }
...
// // EachI
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_EachI_Go(t *testing.B) {
// 	action := func(x interface{}) {
// 		assert.IsType(t, 0, x)
// 	}
// 	for i := range Range(0, nines6) {
...
// func BenchmarkInterSlice_EachI_Optimized(t *testing.B) {
// 	NewIntSlice(Range(0, nines6)).EachI(func(i int, x O) {
// 		assert.IsType(t, 0, x)
// 	})
// }

// func BenchmarkInterSlice_EachI_Reflect(t *testing.B) {
// 	NewInterSlice(Range(0, nines6)).EachI(func(i int, x O) {
// 		assert.IsType(t, 0, x)
// 	})
// }
...
// // EachIE
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_EachIE_Go(t *testing.B) {
// 	action := func(x interface{}) {
// 		assert.IsType(t, 0, x)
// 	}
// 	for i := range Range(0, nines6) {
...
// func BenchmarkInterSlice_EachIE_Optimized(t *testing.B) {
...
// func BenchmarkInterSlice_EachIE_Reflect(t *testing.B) {
// 	NewInterSlice(Range(0, nines6)).EachIE(func(i int, x O) error {
// 		assert.IsType(t, 0, x)
// 		return nil
// 	})
// }
...
// // EachR
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_EachR_Go(t *testing.B) {
// 	action := func(x interface{}) {
// 		assert.IsType(t, 0, x)
// 	}
// 	for i := range Range(0, nines6) {
...
// func BenchmarkInterSlice_EachR_Optimized(t *testing.B) {
// 	NewIntSlice(Range(0, nines6)).EachR(func(x O) {
// 		assert.IsType(t, 0, x)
// 	})
// }

// func BenchmarkInterSlice_EachR_Reflect(t *testing.B) {
// 	NewInterSlice(Range(0, nines6)).EachR(func(x O) {
// 		assert.IsType(t, 0, x)
// 	})
// }
...
// // EachRE
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_EachRE_Go(t *testing.B) {
// 	action := func(x interface{}) {
// 		assert.IsType(t, 0, x)
// 	}
// 	for i := range Range(0, nines6) {
...
// func BenchmarkInterSlice_EachRE_Optimized(t *testing.B) {
...
// func BenchmarkInterSlice_EachRE_Reflect(t *testing.B) {
// 	NewInterSlice(Range(0, nines6)).EachRE(func(x O) error {
// 		assert.IsType(t, 0, x)
// 		return nil
// 	})
// }
...
// // EachRI
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_EachRI_Go(t *testing.B) {
// 	action := func(x interface{}) {
// 		assert.IsType(t, 0, x)
// 	}
// 	for i := range Range(0, nines6) {
...
// func BenchmarkInterSlice_EachRI_Reflect(t *testing.B) {
// 	NewIntSlice(Range(0, nines6)).EachRI(func(i int, x O) {
// 		assert.IsType(t, 0, x)
// 	})
// }

// func BenchmarkInterSlice_EachRI_Optimized(t *testing.B) {
// 	NewInterSlice(Range(0, nines6)).EachRI(func(i int, x O) {
// 		assert.IsType(t, 0, x)
// 	})
// }
...
// // EachRIE
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_EachRIE_Go(t *testing.B) {
// 	action := func(x interface{}) {
// 		assert.IsType(t, 0, x)
// 	}
// 	for i := range Range(0, nines6) {
...
// func BenchmarkInterSlice_EachRIE_Reflect(t *testing.B) {
// 	NewInterSlice(Range(0, nines6)).EachRIE(func(i int, x O) error {
// 		assert.IsType(t, 0, x)
// 		return nil
// 	})
// }

// func BenchmarkInterSlice_EachRIE_Optimized(t *testing.B) {
// 	NewInterSlice(Range(0, nines6)).EachRIE(func(i int, x O) error {
// 		assert.IsType(t, 0, x)
// 		return nil
// 	})
...
// // First
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_First_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 1 {
// 		ints = ints[1:]
// 	}
...
// func BenchmarkInterSlice_First_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.First()
// 	}
...
// func BenchmarkInterSlice_First_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.First()
// 	}
...
// // FirstN
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_FirstN_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	_ = ints[0:10]
// }

// func BenchmarkInterSlice_FirstN_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	slice.FirstN(10)
// }

// func BenchmarkInterSlice_FirstN_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines7))
// 	slice.FirstN(10)
// }
...
// 	{
// 		assert.Equal(t, nil, NewInterSliceV().FirstN(1).O())
// 		assert.Equal(t, nil, NewInterSliceV().FirstN(10).O())
// 		assert.Equal(t, []string{""}, NewInterSliceV("").FirstN(1).O())
// 		assert.Equal(t, []string{""}, NewInterSliceV("").FirstN(10).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3).FirstN(10).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSlice([]int{1, 2, 3}).FirstN(10).O())
// 		assert.Equal(t, []string{"1", "2", "3"}, NewInterSliceV("1", "2", "3").FirstN(10).O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).FirstN(10).O())
// 	}

// 	// grab a few diff
// 	{
// 		assert.Equal(t, []bool{true}, NewInterSliceV(true, false, true).FirstN(1).O())
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false, true).FirstN(2).O())
// 		assert.Equal(t, []int{1}, NewInterSliceV(1, 2, 3).FirstN(1).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3).FirstN(2).O())
// 		assert.Equal(t, []string{"1"}, NewInterSliceV("1", "2", "3").FirstN(1).O())
// 		assert.Equal(t, []string{"1", "2"}, NewInterSliceV("1", "2", "3").FirstN(2).O())
// 		assert.Equal(t, []Object{{1}}, NewInterSlice([]Object{{1}, {2}, {3}}).FirstN(1).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}}).FirstN(2).O())
// 	}
// }

// // Generic
// //--------------------------------------------------------------------------------------------------
// func ExampleInterSlice_Generic() {
// 	slice := NewInterSliceV(1, 2, 3)
...
// // Index
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Index_Go(t *testing.B) {
// 	ints := Range(0, nines5)
// 	for i := range ints {
// 		if ints[i] == nines4 {
// 			break
...
// func BenchmarkInterSlice_Index_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines5))
// 	slice.Index(nines4)
// }

// func BenchmarkInterSlice_Index_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines5))
// 	slice.Index(nines4)
// }
...
// // Insert
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Insert_Go(t *testing.B) {
// 	ints := []int{}
// 	for i := range Range(0, nines6) {
// 		ints = append(ints, i)
// 		copy(ints[1:], ints[1:])
...
// func BenchmarkInterSlice_Insert_Optimized(t *testing.B) {
// 	slice := NewIntSliceV()
// 	for i := range Range(0, nines6) {
// 		slice.Insert(0, i)
// 	}
...
// func BenchmarkInterSlice_Insert_Reflect(t *testing.B) {
// 	slice := NewInterSliceV()
// 	for i := range Range(0, nines6) {
...
// 			assert.Equal(t, []int{0, 1}, NewInterSliceV(0, 1).Insert(-10, 1).O())
// 			assert.Equal(t, []int{0, 1}, NewInterSliceV(0, 1).Insert(10, 1).O())
// 			assert.Equal(t, []int{0, 1}, NewInterSliceV(0, 1).Insert(2, 1).O())
// 			assert.Equal(t, []int{0, 1}, NewInterSliceV(0, 1).Insert(-3, 1).O())
// 		}
// 	}
...
// 			assert.Equal(t, []Object{{0}, {1}}, NewInterSlice([]Object{{0}, {1}}).Insert(-10, 1).O())
// 			assert.Equal(t, []Object{{0}, {1}}, NewInterSlice([]Object{{0}, {1}}).Insert(10, 1).O())
// 			assert.Equal(t, []Object{{0}, {1}}, NewInterSlice([]Object{{0}, {1}}).Insert(2, 1).O())
// 			assert.Equal(t, []Object{{0}, {1}}, NewInterSlice([]Object{{0}, {1}}).Insert(-3, 1).O())
// 		}
// 	}
// }

// func TestInterSlice_Insert_wrongType(t *testing.T) {
// 	slice := NewInterSliceV(1)
// 	defer func() {
// 		err := recover()
...
// // Join
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Join_Go(t *testing.B) {
// 	ints := Range(0, nines4)
// 	strs := []string{}
...
// func BenchmarkInterSlice_Join_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines4))
// 	slice.Join()
// }

// func BenchmarkInterSlice_Join_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines4))
// 	slice.Join()
// }
...
// // Last
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Last_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 1 {
// 		_ = ints[len(ints)-1]
...
// func BenchmarkInterSlice_Last_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.Last()
// 		slice.DropLast()
...
// func BenchmarkInterSlice_Last_Reflect(t *testing.B) {
...
// // LastN
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_LastN_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	_ = ints[0:10]
// }

// func BenchmarkInterSlice_LastN_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	slice.LastN(10)
// }

// func BenchmarkInterSlice_LastN_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines7))
// 	slice.LastN(10)
// }
...
// 	// slice full array includeing out of bounds
// 	{
// 		assert.Equal(t, nil, NewInterSliceV().LastN(1).O())
// 		assert.Equal(t, nil, NewInterSliceV().LastN(10).O())
// 		assert.Equal(t, []string{""}, NewInterSliceV("").LastN(1).O())
// 		assert.Equal(t, []string{""}, NewInterSliceV("").LastN(10).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3).LastN(10).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSlice([]int{1, 2, 3}).LastN(10).O())
// 		assert.Equal(t, []string{"1", "2", "3"}, NewInterSliceV("1", "2", "3").LastN(10).O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).LastN(10).O())
// 	}

// 	// grab a few diff
// 	{
// 		assert.Equal(t, []bool{false}, NewInterSliceV(true, true, false).LastN(1).O())
// 		assert.Equal(t, []bool{false}, NewInterSliceV(true, true, false).LastN(-1).O())
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).LastN(2).O())
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).LastN(-2).O())
// 		assert.Equal(t, []int{3}, NewInterSliceV(1, 2, 3).LastN(1).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3).LastN(2).O())
// 		assert.Equal(t, []string{"3"}, NewInterSliceV("1", "2", "3").LastN(1).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").LastN(2).O())
// 		assert.Equal(t, []Object{{3}}, NewInterSlice([]Object{{1}, {2}, {3}}).LastN(1).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).LastN(2).O())
// 	}
// }
...
// // Less
// //--------------------------------------------------------------------------------------------------
// // func BenchmarkInterSlice_Less_Go(t *testing.B) {
// // 	ints := Range(0, nines6)
// // 	for i := 0; i < len(ints); i++ {
// // 		if i+1 < len(ints) {
// // 			_ = ints[i] < ints[i+1]
...
// // func BenchmarkInterSlice_Less_Optimized(t *testing.B) {
// // 	slice := NewIntSlice(Range(0, nines6))
...
// // func BenchmarkInterSlice_Less_Reflect(t *testing.B) {
// // 	slice := NewInterSlice(rangeInterObject(0, nines6))
// // 	for i := 0; i < slice.Len(); i++ {
// // 		if i+1 < slice.Len() {
// // 			slice.Less(i, i+1)
...
// 	assert.True(t, NewInterSliceV().Nil())
// 	var q *InterSlice
// 	assert.True(t, q.Nil())
...
// // Pop
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Pop_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 1 {
// 		ints = ints[1:]
// 	}
...
// func BenchmarkInterSlice_Pop_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.Pop()
// 	}
...
// func BenchmarkInterSlice_Pop_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.Pop()
// 	}
...
// // PopN
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_PopN_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 10 {
// 		ints = ints[10:]
// 	}
...
// func BenchmarkInterSlice_PopN_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.PopN(10)
// 	}
...
// func BenchmarkInterSlice_PopN_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.PopN(10)
// 	}
...
// // Prepend
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Prepend_Go(t *testing.B) {
// 	ints := []int{}
// 	for i := range Range(0, nines6) {
// 		ints = append(ints, i)
// 		copy(ints[1:], ints[1:])
...
// func BenchmarkInterSlice_Prepend_Optimized(t *testing.B) {
// 	slice := NewIntSliceV()
// 	for i := range Range(0, nines6) {
// 		slice.Prepend(i)
// 	}
...
// func BenchmarkInterSlice_Prepend_Reflect(t *testing.B) {
// 	slice := NewInterSliceV()
// 	for i := range Range(0, nines6) {
...
// // Reverse
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Reverse_Go(t *testing.B) {
// 	ints := Range(0, nines6)
...
// func BenchmarkInterSlice_Reverse_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines6))
// 	slice.Reverse()
// }

// func BenchmarkInterSlice_Reverse_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines6))
// 	slice.Reverse()
// }
...
// 	// empty
// 	{
// 		assert.Equal(t, nil, NewInterSliceV().Reverse().O())
// 	}
...
// // ReverseM
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_ReverseM_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	for i, j := 0, len(ints)-1; i < j; i, j = i+1, j-1 {
// 		ints[i], ints[j] = ints[j], ints[i]
// 	}
...
// func BenchmarkInterSlice_ReverseM_Slice(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines6))
// 	slice.ReverseM()
// }

// func BenchmarkInterSlice_ReverseM_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines6))
// 	slice.ReverseM()
// }
...
// 	// empty
// 	{
// 		assert.Equal(t, nil, NewInterSliceV().ReverseM().O())
// 	}
...
// // Select
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Select_Go(t *testing.B) {
// 	even := []int{}
// 	ints := Range(0, nines6)
// 	for i := 0; i < len(ints); i++ {
// 		if ints[i]%2 == 0 {
...
// func BenchmarkInterSlice_Select_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines6))
...
// func BenchmarkInterSlice_Select_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines6))
// 	slice.Select(func(x O) bool {
// 		return ExB(x.(int)%2 == 0)
// 	})
...
// // Set
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Set_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	for i := 0; i < len(ints); i++ {
// 		ints[i] = 0
// 	}
...
// func BenchmarkInterSlice_Set_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines6))
// 	for i := 0; i < slice.Len(); i++ {
// 		slice.Set(i, 0)
// 	}
...
// func BenchmarkInterSlice_Set_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines6))
// 	for i := 0; i < slice.Len(); i++ {
...
// 	// bool
// 	{
// 		assert.Equal(t, []bool{false, true, true}, NewInterSliceV(true, true, true).Set(0, false).O())
// 		assert.Equal(t, []bool{true, false, true}, NewInterSliceV(true, true, true).Set(1, false).O())
// 		assert.Equal(t, []bool{true, true, false}, NewInterSliceV(true, true, true).Set(2, false).O())
// 		assert.Equal(t, []bool{false, true, true}, NewInterSliceV(true, true, true).Set(-3, false).O())
// 		assert.Equal(t, []bool{true, false, true}, NewInterSliceV(true, true, true).Set(-2, false).O())
// 		assert.Equal(t, []bool{true, true, false}, NewInterSliceV(true, true, true).Set(-1, false).O())
// 	}

// 	// int
// 	{
// 		assert.Equal(t, []int{0, 2, 3}, NewInterSliceV(1, 2, 3).Set(0, 0).O())
// 		assert.Equal(t, []int{1, 0, 3}, NewInterSliceV(1, 2, 3).Set(1, 0).O())
// 		assert.Equal(t, []int{1, 2, 0}, NewInterSliceV(1, 2, 3).Set(2, 0).O())
// 		assert.Equal(t, []int{0, 2, 3}, NewInterSliceV(1, 2, 3).Set(-3, 0).O())
// 		assert.Equal(t, []int{1, 0, 3}, NewInterSliceV(1, 2, 3).Set(-2, 0).O())
// 		assert.Equal(t, []int{1, 2, 0}, NewInterSliceV(1, 2, 3).Set(-1, 0).O())
// 	}

// 	// string
// 	{
// 		assert.Equal(t, []string{"0", "2", "3"}, NewInterSliceV("1", "2", "3").Set(0, "0").O())
// 		assert.Equal(t, []string{"1", "0", "3"}, NewInterSliceV("1", "2", "3").Set(1, "0").O())
// 		assert.Equal(t, []string{"1", "2", "0"}, NewInterSliceV("1", "2", "3").Set(2, "0").O())
// 		assert.Equal(t, []string{"0", "2", "3"}, NewInterSliceV("1", "2", "3").Set(-3, "0").O())
// 		assert.Equal(t, []string{"1", "0", "3"}, NewInterSliceV("1", "2", "3").Set(-2, "0").O())
// 		assert.Equal(t, []string{"1", "2", "0"}, NewInterSliceV("1", "2", "3").Set(-1, "0").O())
// 	}

// 	// custom
// 	{
// 		assert.Equal(t, []Object{{0}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Set(0, Object{0}).O())
// 		assert.Equal(t, []Object{{1}, {0}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Set(1, Object{0}).O())
// 		assert.Equal(t, []Object{{1}, {2}, {0}}, NewInterSlice([]Object{{1}, {2}, {3}}).Set(2, Object{0}).O())
// 		assert.Equal(t, []Object{{0}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Set(-3, Object{0}).O())
// 		assert.Equal(t, []Object{{1}, {0}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Set(-2, Object{0}).O())
// 		assert.Equal(t, []Object{{1}, {2}, {0}}, NewInterSlice([]Object{{1}, {2}, {3}}).Set(-1, Object{0}).O())
// 	}
// }

// // SetE
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_SetE_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	for i := 0; i < len(ints); i++ {
// 		ints[i] = 0
// 	}
...
// func BenchmarkInterSlice_SetE_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines6))
// 	for i := 0; i < slice.Len(); i++ {
// 		slice.SetE(i, 0)
// 	}
...
// func BenchmarkInterSlice_SetE_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines6))
// 	for i := 0; i < slice.Len(); i++ {
...
// // Shift
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Shift_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 1 {
// 		ints = ints[1:]
// 	}
...
// func BenchmarkInterSlice_Shift_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.Shift()
// 	}
...
// func BenchmarkInterSlice_Shift_Relfect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.Shift()
// 	}
...
// // ShiftN
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_ShiftN_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 10 {
// 		ints = ints[10:]
// 	}
...
// func BenchmarkInterSlice_ShiftN_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.ShiftN(10)
// 	}
...
// func BenchmarkInterSlice_ShiftN_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines7))
// 	for slice.Len() > 0 {
// 		slice.ShiftN(10)
// 	}
...
// // Slice
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Slice_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	_ = ints[0:len(ints)]
// }

// func BenchmarkInterSlice_Slice_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	slice.Slice(0, -1)
// }

// func BenchmarkInterSlice_Slice_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines7))
// 	slice.Slice(0, -1)
// }
...
// 	// slice full array
// 	{
// 		assert.Equal(t, nil, NewInterSliceV().Slice(0, -1).O())
// 		assert.Equal(t, nil, NewInterSliceV().Slice(0, 1).O())
// 		assert.Equal(t, nil, NewInterSliceV().Slice(0, 5).O())
// 		assert.Equal(t, []string{""}, NewInterSliceV("").Slice(0, -1).O())
// 		assert.Equal(t, []string{""}, NewInterSliceV("").Slice(0, 1).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3).Slice(0, -1).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSlice([]int{1, 2, 3}).Slice(0, -1).O())
// 		assert.Equal(t, []string{"1", "2", "3"}, NewInterSliceV("1", "2", "3").Slice(0, 2).O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(0, -1).O())
// 	}

// 	// out of bounds should be moved in
// 	{
// 		assert.Equal(t, []string{"1"}, NewInterSliceV("1").Slice(0, 2).O())
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false).Slice(-6, 6).O())
// 		assert.Equal(t, []int{1, 2, 3}, NewInterSliceV(1, 2, 3).Slice(-6, 6).O())
// 		assert.Equal(t, []string{"1", "2", "3"}, NewInterSliceV("1", "2", "3").Slice(-6, 6).O())
// 		assert.Equal(t, []Object{{1}, {2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(-6, 6).O())
// 	}
...
// 	// grab all but first
// 	{
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).Slice(1, -1).O())
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).Slice(1, 2).O())
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).Slice(-2, -1).O())
// 		assert.Equal(t, []bool{false, true}, NewInterSliceV(true, false, true).Slice(-2, 2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3).Slice(1, -1).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3).Slice(1, 2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3).Slice(-2, -1).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3).Slice(-2, 2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Slice(1, -1).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Slice(1, 2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Slice(-2, -1).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Slice(-2, 2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(1, -1).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(1, 2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(-2, -1).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(-2, 2).O())
// 	}

// 	// grab all but last
// 	{
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false, true).Slice(0, -2).O())
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false, true).Slice(-3, -2).O())
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false, true).Slice(-3, 1).O())
// 		assert.Equal(t, []bool{true, false}, NewInterSliceV(true, false, true).Slice(0, 1).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3).Slice(0, -2).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3).Slice(-3, -2).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3).Slice(-3, 1).O())
// 		assert.Equal(t, []int{1, 2}, NewInterSliceV(1, 2, 3).Slice(0, 1).O())
// 		assert.Equal(t, []string{"1", "2"}, NewInterSliceV("1", "2", "3").Slice(0, -2).O())
// 		assert.Equal(t, []string{"1", "2"}, NewInterSliceV("1", "2", "3").Slice(-3, -2).O())
// 		assert.Equal(t, []string{"1", "2"}, NewInterSliceV("1", "2", "3").Slice(-3, 1).O())
// 		assert.Equal(t, []string{"1", "2"}, NewInterSliceV("1", "2", "3").Slice(0, 1).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(0, -2).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(-3, -2).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(-3, 1).O())
// 		assert.Equal(t, []Object{{1}, {2}}, NewInterSlice([]Object{{1}, {2}, {3}}).Slice(0, 1).O())
// 	}

// 	// grab middle
// 	{
// 		assert.Equal(t, []bool{true, true}, NewInterSliceV(false, true, true, false).Slice(1, -2).O())
// 		assert.Equal(t, []bool{true, true}, NewInterSliceV(false, true, true, false).Slice(-3, -2).O())
// 		assert.Equal(t, []bool{true, true}, NewInterSliceV(false, true, true, false).Slice(-3, 2).O())
// 		assert.Equal(t, []bool{true, true}, NewInterSliceV(false, true, true, false).Slice(1, 2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3, 4).Slice(1, -2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3, 4).Slice(-3, -2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3, 4).Slice(-3, 2).O())
// 		assert.Equal(t, []int{2, 3}, NewInterSliceV(1, 2, 3, 4).Slice(1, 2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3", "4").Slice(1, -2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3", "4").Slice(-3, -2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3", "4").Slice(-3, 2).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3", "4").Slice(1, 2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Slice(1, -2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Slice(-3, -2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Slice(-3, 2).O())
// 		assert.Equal(t, []Object{{2}, {3}}, NewInterSlice([]Object{{1}, {2}, {3}, {4}}).Slice(1, 2).O())
// 	}
...
// 	// random
// 	{
// 		assert.Equal(t, []string{"1"}, NewInterSliceV("1", "2", "3").Slice(0, -3).O())
// 		assert.Equal(t, []string{"2", "3"}, NewInterSliceV("1", "2", "3").Slice(1, 2).O())
// 		assert.Equal(t, []string{"1", "2", "3"}, NewInterSliceV("1", "2", "3").Slice(0, 2).O())
// 	}
// }
...
// // String
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_String_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	_ = fmt.Sprintf("%v", ints)
// }

// func BenchmarkInterSlice_String_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines6))
// 	_ = slice.String()
// }

// func BenchmarkInterSlice_String_Optimized(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines6))
// 	_ = slice.String()
// }
...
// // Sort
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Sort_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	sort.Sort(sort.IntSlice(ints))
// }

// func BenchmarkInterSlice_Sort_Slice(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines6))
// 	slice.Sort()
// }
...
// // SortM
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_SortM_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	sort.Sort(sort.IntSlice(ints))
// }

// func BenchmarkInterSlice_SortM_Slice(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines6))
// 	slice.SortM()
// }
...
// // SortReverse
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_SortReverse_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	sort.Sort(sort.Reverse(sort.IntSlice(ints)))
// }

// func BenchmarkInterSlice_SortReverse_Slice(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines6))
// 	slice.SortReverse()
// }
...
// // SortReverseM
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_SortReverseM_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	sort.Sort(sort.Reverse(sort.IntSlice(ints)))
// }

// func BenchmarkInterSlice_SortReverseM_Slice(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines6))
// 	slice.SortReverseM()
// }
...
// // Swap
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Swap_Go(t *testing.B) {
// 	ints := Range(0, nines6)
// 	for i := 0; i < len(ints); i++ {
// 		if i+1 < len(ints) {
...
// func BenchmarkInterSlice_Swap_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines6))
// 	for i := 0; i < slice.Len(); i++ {
// 		if i+1 < slice.Len() {
// 			slice.Swap(i, i+1)
...
// func BenchmarkInterSlice_Swap_Reflect(t *testing.B) {
// 	slice := NewInterSlice(rangeInterObject(0, nines6))
// 	for i := 0; i < slice.Len(); i++ {
// 		if i+1 < slice.Len() {
// 			slice.Swap(i, i+1)
...
// // Take
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_Take_Go(t *testing.B) {
// 	ints := Range(0, nines7)
// 	for len(ints) > 11 {
// 		i := 1
// 		n := 10
...
// func BenchmarkInterSlice_Take_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines7))
// 	for slice.Len() > 1 {
// 		slice.Take(1, 10)
// 	}
...
// func BenchmarkInterSlice_Take_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines7))
// 	for slice.Len() > 1 {
// 		slice.Take(1, 10)
// 	}
...
// // TakeAt
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_TakeAt_Go(t *testing.B) {
// 	ints := Range(0, nines5)
// 	index := Range(0, nines5)
// 	for i := range index {
// 		if i+1 < len(ints) {
...
// func BenchmarkInterSlice_TakeAt_Optimized(t *testing.B) {
// 	src := Range(0, nines5)
// 	index := Range(0, nines5)
// 	slice := NewIntSlice(src)
// 	for i := range index {
...
// func BenchmarkInterSlice_TakeAt_Reflect(t *testing.B) {
...
// // TakeW
// //--------------------------------------------------------------------------------------------------
// func BenchmarkInterSlice_TakeW_Go(t *testing.B) {
// 	new := []int{}
// 	ints := Range(0, nines5)
// 	l := len(ints)
// 	for i := 0; i < l; i++ {
...
// func BenchmarkInterSlice_TakeW_Optimized(t *testing.B) {
// 	slice := NewIntSlice(Range(0, nines5))
// 	slice.TakeW(func(x O) bool { return ExB(x.(int)%2 == 0) })
// }

// func BenchmarkInterSlice_TakeW_Reflect(t *testing.B) {
// 	slice := NewInterSlice(Range(0, nines5))
// 	slice.TakeW(func(x O) bool { return ExB(x.(int)%2 == 0) })
// }
