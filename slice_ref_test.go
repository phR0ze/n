...
// DropFirst
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_DropFirst_Normal(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 1 {
		ints = ints[1:]
	}
...
// DropFirstN
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_DropFirstN_Normal(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 10 {
		ints = ints[10:]
	}
...
// DropLast
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_DropLast_Normal(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 1 {
		ints = ints[1:]
	}
...
// DropLastN
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_DropLastN_Normal(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 10 {
		ints = ints[10:]
	}
...
// Each
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_Each_Normal(t *testing.B) {
...
// EachE
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_EachE_Normal(t *testing.B) {
	action := func(x interface{}) {
		assert.IsType(t, 0, x)
	}
	for i := range Range(0, nines6) {
...
// First
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_First_Normal(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 1 {
		ints = ints[1:]
	}
...
func TestRefSlice_First(t *testing.T) {
	// invalid
	{
		assert.Equal(t, &Object{nil}, NewRefSliceV().First())
	}
...
// FirstN
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_FirstN_Normal(t *testing.B) {
	ints := Range(0, nines7)
	_ = ints[0:10]
}
...
// Last
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_Last_Normal(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 1 {
		_ = ints[len(ints)-1]
...
func TestRefSlice_Last(t *testing.T) {
	...
	// invalid
	{
		assert.Equal(t, &Object{nil}, NewRefSliceV().Last())
	}

	// int
	{
		assert.Equal(t, &Object{3}, NewRefSliceV(2, 3).Last())
		assert.Equal(t, &Object{2}, NewRefSliceV(3, 2).Last())
		assert.Equal(t, &Object{2}, NewRefSliceV(1, 3, 2).Last())
	}
...
// LastN
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_LastN_Normal(t *testing.B) {
	ints := Range(0, nines7)
	_ = ints[0:10]
}
...
// // Less
// //--------------------------------------------------------------------------------------------------
// func BenchmarkRefSlice_Less_Normal(t *testing.B) {
// 	ints := Range(0, nines6)
...
// Set
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_Set_Normal(t *testing.B) {
	ints := Range(0, nines6)
	for i := 0; i < len(ints); i++ {
		ints[i] = 0
	}
...
// SetE
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_SetE_Normal(t *testing.B) {
	ints := Range(0, nines6)
	for i := 0; i < len(ints); i++ {
		ints[i] = 0
	}
...
// Shift
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_Shift_Normal(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 1 {
		ints = ints[1:]
	}
...
// ShiftN
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_ShiftN_Normal(t *testing.B) {
	ints := Range(0, nines7)
	for len(ints) > 10 {
		ints = ints[10:]
	}
...
// Swap
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_Swap_Normal(t *testing.B) {
	ints := Range(0, nines6)
	for i := 0; i < len(ints); i++ {
		if i+1 < len(ints) {
...
// TakeAt
//--------------------------------------------------------------------------------------------------
func BenchmarkRefSlice_TakeAt_Normal(t *testing.B) {
	ints := Range(0, nines5)
	index := Range(0, nines5)
	for i := range index {
		if i+1 < len(ints) {
